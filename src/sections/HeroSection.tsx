      ...
      <div className="relative z-10 max-w-6xl flex flex-col items-center">
        ...
        {!user && (
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-up" style={{ animationDelay: '400ms' }}>
            <Button size="lg" onClick={openRegister} className="shadow-[0_0_50px_rgba(0,255,192,0.4)] font-orbitron font-black uppercase tracking-[0.2em] py-8 px-16 text-lg md:text-xl animate-pulse-glow border-2 border-[#00FFC0] hover:scale-105 transition-transform">
                [ JOIN THE CIRCUIT ]
            </Button>
          </div>
        )}
