...
export const AboutSection = () => {
  return (
    <section id="about" className="bg-[#000000] py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#00FFC0]/5 to-transparent pointer-events-none opacity-50"></div>
      
      <div className="container mx-auto grid max-w-7xl grid-cols-1 gap-16 px-4 md:grid-cols-2 relative z-10">
        <div className="flex flex-col justify-center">
          <span className="mb-3 font-heading text-sm font-bold text-[#00FFC0] uppercase tracking-widest">Built by Degens, For the Edge</span>
        ...
        <div className="flex items-center justify-center">
          <div className="w-full rounded-2xl bg-[#14131c] border border-[#3a3846] p-8 md:p-10 shadow-2xl">
            <h3 className="font-heading mb-6 text-2xl font-bold text-white flex items-center gap-3">
              <Icons.Target className="h-6 w-6 text-[#00FFC0]" />
              The Core Problem
            </h3>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 text-white">
                <div className="mt-1 p-1 bg-[#00FFC0]/20 rounded-full">
